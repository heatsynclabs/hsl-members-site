...
import ErrorIcon from './info-hexa.svg?react';
...
import MoreDotIcon from './MoreDotIcon.svg?react';
import AiIcon from './ai-icon.svg?react';
import CartIcon from './cart-icon.svg?react';
import CallIcon from './call-icon.svg?react';
import BoxMoving from './box-tapped.svg?react';
import BoxTapped from './box-icon.svg?react';
import TruckDelivery from './truck-delivery.svg?react';
